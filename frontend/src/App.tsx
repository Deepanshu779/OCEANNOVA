        ...
        <main className="content">
          <section className="hero competition-hero">
            ...
            <div className="hero-visual" aria-hidden="true">
              ...
              <div className="float-card float-bottom"><span>DETECTED FOOTPRINT</span><strong>{investigation.area_km2.toFixed(2)} km²</strong><small>geo-referenced prediction</small></div>
              <div className="orbit-label">EVIDENCE<br /><b>01</b></div>
            </div>
          </section>

          <section className="stats-row">
            <div className="stat-card accent-cyan"><span className="stat-icon">◈</span><div><small>SATELLITE EVIDENCE</small><strong>REAL SAR</strong><p>{source} observation</p></div></div>
            <div className="stat-card accent-coral"><span className="stat-icon">●</span><div><small>DETECTED FOOTPRINT</small><strong>{investigation.area_km2.toFixed(2)} km²</strong><p>AI-predicted area</p></div></div>
            <div className="stat-card accent-purple"><span className="stat-icon">⌁</span><div><small>MODEL SIGNAL</small><strong>{confidence.toFixed(1)}%</strong><p>Mean confidence on mask</p></div></div>
            <div className="stat-card accent-green"><span className="stat-icon">✓</span><div><small>PROVENANCE</small><strong>{crs}</strong><p>Geo-referenced output</p></div></div>
          </section>
          ...
          <section className="workspace-grid">
            ...
            <div className="insight-column">
              ...
              <section className="card signal-card">
                <div className="card-header"><div><span className="section-kicker">TRANSPARENCY</span><h2>Evidence readiness</h2></div></div>
                <div className="readiness-meter"><div><span>Core satellite investigation</span><b>READY</b></div><div className="meter"><i style={{ width: "100%" }} /></div></div>
                <div className="signal-row"><i className="signal-green" /><div><strong>Radar segmentation</strong><span>Real Sentinel-1 evidence</span></div><b>✓</b></div>
                <div className="signal-row"><i className="signal-blue" /><div><strong>Geometry & GeoJSON</strong><span>Derived from prediction mask</span></div><b>✓</b></div>
                <div className="signal-row muted"><i /><div><strong>Historical AIS</strong><span>Not loaded for this case</span></div><b>—</b></div>
                <div className="signal-row muted"><i /><div><strong>Ocean forcing</strong><span>Not loaded for this case</span></div><b>—</b></div>
              </section>
            </div>
          </section>
